...
def show_menu():
    ...
    try:
        choice = int(input(' < Please enter your selection option 1-4: '))

        return choice
    except ValueError:
        print("\n  You've chosen an incorrect number., program Exit...\n")        
        sys.exit(0)
...
def show_books(_cursor):
    ...
    # this iterate over the player data set and display the results 
    for book in books:
...
def validate_user():
    ...
    try:
        ...
        print("\n  You've chosen an incorrect number, program terminated...\n")
